...
avg_sacos10K=getDB(sql_str_10_avg)
avg_sacos25K=getDB(sql_str_25_avg)
...
if sum_sacos25K == None:
   sum_sacos25K="0"
if avg_sacos10K == None:
   avg_sacos10K="0"
if avg_sacos25K == None:
   avg_sacos25K="0"
...
worksheet.write(7, 6, int(avg_sacos10K))
...
worksheet.write(11, 6, int(avg_sacos25K))
worksheet.write(13, 1,'Costo x kilo procesado:',bold)
worksheet.write(13, 6, float(result_total),currency_format)
...
worksheet.write(19,1,'Detenciones',bold)
...
logging.info("mail sent to aguileraelectro@gmail.com")
